...
#else
static const char *fonts[]               = { "JetBrains Mono Medium:style:medium:size=10", "JetBrainsMono Nerd Font Mono:style:medium:size=14", "Material Design Icons Desktop:size=14" };
...
static char selfgcolor[]                 = "#030031";
static char selbgcolor[]                 = "#bbbbbb";
static char selbordercolor[]             = "#002d7e";
static char selfloatcolor[]              = "#bbbbbb";
...
static char tagsselbgcolor[]             = "#031d4b"; //"#031d4b";
static char tagsselbordercolor[]         = "#031d4b"; //"#031d4b";
static char tagsselfloatcolor[]          = "#ffffff"; //"#031d4b";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_t,         	spawn,                  SHCMD("telegram-desktop") },
        { MODKEY|ShiftMask,             XK_r,          	spawn,                  SHCMD("rofi -show drun -show-icon") },
        { 0,                            XK_Print,      	spawn,                  SHCMD("flameshot gui") },
	{ MODKEY|ShiftMask,		XK_minus,	spawn,			SHCMD("pamixer -d 5; kill -35 $(pgrep -a dwmblocks | awk '{ printf $1 }')") },
	{ MODKEY|ShiftMask,             XK_equal,       spawn,                  SHCMD("pamixer -i 5; kill -35 $(pgrep -a dwmblocks | awk '{ printf $1 }')") },
	{ Mod1Mask, 			XK_Shift_L, 	spawn,			SHCMD("xkb-switch --next; kill -36 $(pgrep -a dwmblocks | awk '{ printf $1 }')") },
